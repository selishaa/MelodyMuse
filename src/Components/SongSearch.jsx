...
export default function SongSearch() {
    ...
    const redirectSongData = (elem) => {
        navigate('/player', { state: elem })
    }
                                            ...
                                            <div key={index} className="bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 shadow-lg rounded p-3 w-2/3 m-10">
                                                <div className="group relative">
                                                    ...
                                                    <div className="absolute bg-black rounded bg-opacity-0 group-hover:bg-opacity-60 w-full h-full top-0 flex items-center group-hover:opacity-100 transition justify-evenly">
                                                        ...
                                                        <button className="hover:scale-110 text-white opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition" onClick={() => redirectSongData(elem)}>
